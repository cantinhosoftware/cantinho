...
base='YOUR SITE HERE'
ADDON=xbmcaddon.Addon(id='cantinho')
...
def CATEGORIES():
    link = OPEN_URL('AQUI METES O LINK DO FICHEIRO TXT QUE FICA NO MEO DRIVE ').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("cantinho","Downloading ",'', 'Please Wait')
